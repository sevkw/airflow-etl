...
HOST_NAME = 'your database host address>'
...
# note that we are using path to s3 bucket
raw_data_path = 's3://recalls-data/cleaned_data/recalls_raw.csv'
cleaned_data_path = 's3://recalls-data/raw_data/recalls_cleaned.csv'

# define a dag variable based on the Airflow DAG object
dag = DAG(
    dag_id='recalls_etl_s3_rds',
